...
horário
em que as estatísticas mostram que tem mais gente assistindo
...
transformados em
“todo mundo”, nem podem ser considerados “representativos” de toda a
...
amostra. É, porém, absolutamente essencial que as amostras sejam *representativas* da população de onde foram retiradas. Mais ainda, é
...
A *amostra por quotas* é constituída por unidades retiradas da
...
entrevista quem trabalha em horário diurno. Essa amostra é tendenciosa por não captar informação desse tipo de pessoa. Se você fizer
...
O próprio entrevistador pode tornar as respostas tendenciosas pela
...
do período eleitoral, aprovação ao governo ou a determinado governante, posicionamento perante um tema de interesse nacional, são
...
Para desenhar o *gráfico de setores* traça-se uma circunferência,
...
da República, num ano eleitoral. Para fazer isso, contrata um instituto de pesquisa que verifica, durante dois dias e em diversas cidades
...
mas você pode querer melhorar o aspecto visual. Dê uma terceira dimensão à figura — é o chamado gráfico em 3D. É muito importante manter
...
Considere que o consumo de madeiras de florestas nativas pelas serrarias no Brasil, em mil metros cúbicos, foi de 27.325
...
milhões que você ganhou em cada mês no eixo vertical. Cada valor é representado por um ponto. Se você unir os pontos terá a tendência de
seus negócios!
...
média pode ser um número que nem sequer existe no conjunto. Por exemplo, qual é a média de
...
A mediana separa o conjunto em duas partes: na primeira parte ficam
...
distribuem. Então, dado o conjunto de números
...
valores muito próximos. Isso acontece quando a variável tem distribuição aproximadamente normal. Para entender o que é *distribuição
...
coeficientes de expansão ou de elasticidade, durabilidade de produtos — também têm distribuição aproximadamente normal. Só que isso em geral
...
Se foram reprovados todos os 322 alunos que prestaram exames
...
E se foram reprovados 322 alunos, mas
...
E não faz sentido calcular porcentagens quando os totais são muito
...
100,00) dá a *margem de comercialização*. Para o exemplo:
...
Em relação ao número de itens vendidos
...
“O número de itens vendidos aumentou em 100%” 

“Houve uma queda de 20% no preço do produto”
...
dólar no mês —, dizemos que essas variáveis não têm correlação. O diagrama de dispersão dado a seguir mostra variáveis que não têm
correlação.
...
da outra. Pode
haver uma *terceira variável* que faça as duas primeiras variáveis
...
Portanto, se você achar correlação positiva entre o número de
...
deixou de obedecer. Então, o cientista escreveu: “Existe correlação negativa entre o número de pernas funcionais de aranhas e a
capacidade auditiva de tais aracnídeos”.

# As “provas” que não provam
...
ao costureiro, ao iluminador, ao fotógrafo, além — é claro — do xampu?
...
“é tudo careta”, ou qualquer outro chavão. Feitas as estatísticas,
...
incidência de cáries nos dois grupos. À primeira vista, o experimento parece simples, mas não é bem assim. Quem garante que as
...
despesa de cada uma dessas famílias, em determinado período (por exemplo, um mês). Nas despesas de todas as famílias, você vai encontrar
gastos com produtos de consumo (alimentação, vestuário, habitação,
saúde e cuidados pessoais) e gastos com serviços (água, luz,
transporte e comunicação, lazer). 

Mas não basta saber *com o que* as
...
residência para famílias com rendimentos mensais compreendidos entre
...
duas
pessoas: uma tem 36°C de temperatura (a unidade de medida está em
...
Como se faz para transformar valor corrente em valor deflacionado?
...
instituições e nos jornais. 

O deflator permite transformar valores
...
Afirma-se que as famílias se tornaram menores. Para verificar essa
...
tuberculose aumentou ao longo do século. Afinal, a população aumentou, e também aumentaram a qualidade dos registros e os meios de
...
provava o caldo e dizia “Era bruxa” ou “Não era bruxa”. Tanta autoridade assusta! Então, talvez seja melhor usar a estatística para
